  ...
  <body>
    <header class="header">
      ...
      <ul class="menu">
        ...
        <li>
          <a href="./ad-products.php"><i class="fab fa-product-hunt"></i>Products</a>
        </li>
        <li>
        ...
        <li class="active">
          <a href="./ad-vet.html"
            ><i class="fas fa-user-md"></i>Veterinarian</a
          >
        </li>
        <li>
